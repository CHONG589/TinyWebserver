...
void HttpServer::handleClient(Socket::ptr client) {
    ...
    auto callback = std::bind(&HttpServer::handleClient, self, client);
...
void HttpServer::startAccept(Socket::ptr sock) {
    ...
    m_ioWorker->schedule(std::bind(&HttpServer::startAccept, std::dynamic_pointer_cast<HttpServer>(shared_from_this()), sock));
}
